...
export const conceptosColumns = (onEdit, onToggleStatus) => [
  {
    field: "nombre",
    headerName: "Nombre",
    flex: 2,
  ...
  {
    field: "clave_concepto",
    headerName: "Clave de Concepto",
    flex: 1,
  },
  {
    field: "activo",
  ...
  },
  {
    ...
    filterable: false,
    renderCell: (params) => {
      const { id_concepto, activo } = params.row;
      ...
      return (
        <div className="flex items-center justify-center gap-4">
          ...
          <Tooltip title={activo ? "Desactivar Concepto" : "Activar Concepto"}>
            <button
              onClick={() => onToggleStatus(id_concepto, activo)}
