...
export const seccionesColumns = (onEdit, onToggleStatus) => [
  {
    field: "nombre",
    headerName: "Nombre",
    flex: 2,
  ...
  },
  {
    ...
    filterable: false,
    renderCell: (params) => {
      const { id_seccion, activo } = params.row;
      ...
      return (
        <div className="flex items-center justify-center gap-4">
          ...
          <Tooltip title={activo ? "Desactivar Sección" : "Activar Sección"}>
            <button
              onClick={() => onToggleStatus(id_seccion, activo)}
