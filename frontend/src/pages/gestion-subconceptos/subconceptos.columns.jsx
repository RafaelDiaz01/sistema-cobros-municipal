...
export const subconceptosColumns = (onEdit, onToggleStatus) => [
  ...
  },
  {
    ...
    filterable: false,
    renderCell: (params) => {
      const { id_subconcepto, activo } = params.row;

      return (
        <div className="flex items-center justify-center gap-4">
          <Tooltip title="Editar Subconcepto">
            <button
          ...
          <Tooltip
            title={activo ? "Desactivar Subconcepto" : "Activar Subconcepto"}
          >
            <button
              onClick={() => onToggleStatus(id_subconcepto, activo)}
