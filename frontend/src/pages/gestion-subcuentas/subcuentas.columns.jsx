...
export const subcuentasColumns = (onEdit, onToggleStatus) => [
  {
    field: "nombre",
    headerName: "Nombre",
    flex: 2,
  ...
  {
    field: "clave_subcuenta",
    headerName: "Clave de Subcuenta",
    flex: 1,
  },
  {
    field: "es_cobrable",
  ...
  },
  {
    ...
    filterable: false,
    renderCell: (params) => {
      const { id_subcuenta, activo } = params.row;

      return (
        <div className="flex items-center justify-center gap-4">
          <Tooltip title="Editar Subcuenta Contable">
            <button
          ...
          <Tooltip
            title={
              activo
                ? "Desactivar Subcuenta Contable"
                : "Activar Subcuenta Contable"
            }
          >
            <button
              onClick={() => onToggleStatus(id_subcuenta, activo)}
